...
appHorse.controller('horseController', function($scope, $mdDialog, $timeout, $location, potentialService, dislikeService, likeService, currentUserService, $localStorage) {
